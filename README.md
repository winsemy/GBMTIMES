...
- 요금제 선택 페이지 : 사용자는 요금제를 선택하고 결제할 수 있습니다.
...
- 김도유 :  펀딩 프로젝트 만들기 페이지/ 결제하기/ 임시 저장 기능/ 프로젝트 수정 기능 / 최종 등록 전 미리보기 및 다운로드 기능/ 프로젝트 최종 등록 기능/ 펀딩 프로젝트 관리 - 펀딩 현황, 결제 현황, 멤버 관리(멤버 추가 및 삭제) 
