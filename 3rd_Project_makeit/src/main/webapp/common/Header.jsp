							...
							<ul>
								...
								<li><a href="#">More</a>
									<ul class="dropdown">
										...
										<li><a href="javascript:gopage('${user.memberId }','qna.do')">Q&A</a></li>
									</ul></li>
						...
						<c:if test="${ not empty user.memberId }">
											...
											<li>
												<div class="cart-item-desc">
													<div>
														<a href="#"></a>
														<p>
															알림이 없습니다<span class="price"></span>
														</p>
													</div>
												</div>
											</li>
							...
							<c:if test="${ not empty adList }">
								<div class="cart-area">
									...
									<c:if test="${adList[0].adCnt != 0 }">
										<div class="cart--btn">
											<i class="fa fa-bell"></i> <span class="cart_quantity">${adList[0].adCnt }</span>
										</div>
										<div class="cart-dropdown-content">
											<ul class="cart-list">
												<c:forEach var="ad" items="${adList }">
													<c:if test="${ad.adCheck == 1 }">
														<li>
															<div class="cart-item-desc">
																<div>
																	<a href="#">광고 승인 완료</a>
																	<p>
																		결제 요청 - <span class="price">${ad.adPrice } ￦</span>
																	</p>
																</div>
															</div> <span
															onclick="location.href='adPay.do?adIdx=${ad.adIdx}'"
															class="dropdown-product-remove"><i
