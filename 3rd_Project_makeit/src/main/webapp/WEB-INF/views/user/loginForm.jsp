                    ...
                    <div class="login_form mb-50">
                        ...
                        <form action="memberLogin.do" method="post">
                            <div class="form-group">
                                <input type="text" class="form-control" id="memberId" name="memberId" value="wpgh123" placeholder="ID">
                                <div class="check_font" id="id_check"></div>
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control" id="memberPwd" name="memberPwd" value="rjqnrdl0!" placeholder="Password">
