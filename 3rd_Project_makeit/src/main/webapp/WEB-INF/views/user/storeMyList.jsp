...
<c:if test="${user.memberId eq ''}">
			...
			<div class="row h-100 align-items-center">
				<div class="col-12">
					...
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">My Store List</li>
					</ol>
				</div>
			</div>
		</div>
	...
	<br>
	<div class="container">
		<h2 style="font-weight: bold;">나의 스토어</h2>
                    ...
                    <div class="cart-table">
                        <div class="table-responsive">
                            <table class="table table-bordered mb-30">
                                ...
                                <tbody>
                                	<c:if test="${ empty storeMyList }">
                                		<tr>
                                			<th colspan="4">문의 내역이 없습니다</th>
                                		</tr>
                                	</c:if>
                                	<c:if test="${ not empty storeMyList }">
                                	<c:forEach var="order" items="${storeMyList }">
	                                    <tr>
	                                        <td>
									...
									<div class="shop_pagination_area mt-30">
										<nav aria-label="Page navigation">
											<ul class="pagination pagination-sm justify-content-center"  style="display: flex;" id="ajaxpageinsert" >
												...
												<c:if test="${page.beginPage!=1 }">
													<li class="page-item">
														<a class="page-link" href="storeMyList.do?cPage=${page.beginPage-1}&memberId=${user.memberId}"><i class="fa fa-angle-left" aria-hidden="true"></i></a>
													</li>
												</c:if>
												...
												<c:forEach var="pageNo" begin="${page.beginPage }" end="${page.endPage }">
													...
													<c:if test="${pageNo != page.nowPage }">
														<li class="page-item">
															<a class="page-link" href="storeMyList.do?cPage=${pageNo }&memberId=${user.memberId}">${pageNo }</a>
	 													</li>
													</c:if>
												</c:forEach>
												...
												<li class="page-item"> 
													<a class="page-link" href="storeMyList.do?cPage=${page.endPage +1 }&memberId=${user.memberId}"><i class="fa fa-angle-right" aria-hidden="true"></i></a>
												</li>
												</c:if>
												<c:if test="${page.endPage >= page.totalPage  }">
													<li class="page-item">
