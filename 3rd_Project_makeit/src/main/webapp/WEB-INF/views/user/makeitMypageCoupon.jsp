		...
		success:function(data){
			...
			if(data.list.length==0){
				...
				$.each(data.list,function(index,list){
					...
					couponHtml += "<p class='text-muted mb-0'>" + list.couponPrice + " 할인</p></div></div>";
		...
		success:function(data){
			...
			if(data.list.length==0){
				...
				$.each(data.list,function(index,list){
					...
					myCouponHtml +=	"<h5 class='title'>" + list.couponPrice + " 원</h5>"
		...
		success:function(data){
			...
			if(data.list.length==0){
				...
				$.each(data.list,function(index,list){
					...
					CouponHisHtml +="<h5 class='title'>" + list.couponPrice + " 원</h5>"
											    ...
											    <div class="coupon bg-light rounded mb-3 d-flex justify-content-between">
									                ...
									                <div class="tengah py-3 d-flex w-100 justify-content-start">
									                    <div>
									                        ...
									                        <p class="text-muted mb-0">${list.couponPrice } 할인</p>
									                    </div>
									                </div>
									                <div class="kanan">
