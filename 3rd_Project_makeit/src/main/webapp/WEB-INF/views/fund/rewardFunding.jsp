							...
							<div class="order-box">
								...
								<div class="fund_coupon_selectBox">
									...
									<div class="fund_order-box">
										...
										<div style="font-weight: 200;">
											...
											<div style="float: right; font-size: 13px;">
												<span><b style="float: right;" id="optionPrice">${rewardFunding.fundOptionPrice }&nbsp;<b style="float: right;">원</b></b> </span><br>
												<span >-<b style="float: right;"><input id="couponInput" style="text-align: right;"><b >&nbsp;원</b></b></span><br>
												<span><b style="float: right;" id="deliveryPrice">${rewardFunding.fundOptionDelivery }&nbsp;<b style="float: right;">원</b></b></span><br>
											</div>
										</div>
									</div>
									<br>
									...
									<div class="count" style="width: 80px; float: right;">
		                                <input type="number" class="qty-text form-control" id="count" step="1" min="1" max="5" name="count" value="1" >
		                           		<div id="result"></div>
		                            </div>
									<br>
									<br>
									...
									<div style="float: right; font-size: 15px;">
										<c:if test="${empty couponList }">
											<span><b><input id="totalPrice" name="totalPrice" style="font-weight: bold;text-align: right;" value="${rewardFunding.fundOptionPrice +  rewardFunding.fundOptionDelivery}" >&nbsp;<b>원</b></b></span><br>
										</c:if>
										<c:if test="${not empty couponList }">
											<span><b><input id="totalPrice"  name="totalPrice" style="font-weight: bold;text-align: right;" value="${rewardFunding.fundOptionPrice +  rewardFunding.fundOptionDelivery}" >&nbsp;<b>원</b></b></span><br>
										</c:if>
...
var selectBox = function (value) {
	...
	console.log(fundTotalPrice);

	$('#totalPrice').val(fundTotalPrice);
}
