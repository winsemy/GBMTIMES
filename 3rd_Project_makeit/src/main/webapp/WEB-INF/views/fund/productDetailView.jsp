                ...
                <div class="col-12">
                    <div class="product_details_tab section">
                        ...
                        <ul class="nav nav-tabs" role="tablist" id="product-details-tab">
                            <li class="nav-item">
                                <a href="productDetailView.do?fundIdx=${productDetailView.fundIdx }" class="nav-link active" >스토리</a>
                            </li>
                            <li class="nav-item">
                                <a href="getCommentList.do?fundIdx=${productDetailView.fundIdx }" class="nav-link" >커뮤니티 (${productDetailView.communityCnt })<span class="text-muted"></span></a>
                            </li>
                            <li class="nav-item">
                                <a href="returnAndCancel.do" class="nav-link" >반환 ·  정책</a>
                            </li>
                            <li class="nav-item">
                                <a href="getSupporter.do?fundIdx=${productDetailView.fundIdx }" class="nav-link" >서포터 (${productDetailView.supporterCnt })  </a>
                            </li>
                        </ul>
						                    ...
						                    <div class="single_product_thumb">
						                        <div id="product_details_slider" class="carousel slide" data-ride="carousel">
						                            ...
						                            <div class="short-box">
				                       					...
				                       					<b class="ftitle mb-2">${productDetailView.fundTargetPrice} 원</b><br>
						          		...
						          		<div class="col-12 col-md-6 col-lg-4">
						                    ...
						                    <div class="single_product_desc">
						                       <h4 class="title mb-2"> <b>${productDetailView.fundTitle }</b></h4>
						                        <h4 class="price mb-2">${productDetailView.fundPrice } 원 펀딩</h4>
						                        <h4 class="price mb-2">${productDetailView.fundTotalPricePercent } %</h4>
						                       ...
						                       <c:choose>
				                    			...
				                    			<div class="product_wishlist">
							                 		<img src="img/fund/white-Heart.png" alt="like" id="white-heart">
							                 		<b class="product-price">&nbsp; ( ${productDetailView.likeCnt } )</b>
							         			</div>
						                        <!-- Q&A  -->
						                    ...
						                    <div class="single_product_desc">
						                        ...
						                        <div class="others_info_area mb-3 d-flex flex-wrap">
						                          <div class="maker-information">
					                            		...
					                            		<br>
				                            			<c:if test="${productDetailView.fundMakerId ne productDetailView.followingId && user.memberId ne productDetailView.followerId}">
				                            				<div id="followBtn" style="text-align:center;">
					                            				<a id="insertFollow"  onclick="return confirm ('팔로우 하시겠습니까?');" href="insertFollow.do?followingId=${productDetailView.fundMakerId }&followerId=${user.memberId }&fundIdx=${productDetailView.fundIdx }">
								                            		<i class="fa fa-user-plus"></i>&nbsp; 팔로우
								                            	</a>	
							                            	</div>
				                            			</c:if>
				                            			<c:if test="${productDetailView.fundMakerId eq productDetailView.followingId && user.memberId eq productDetailView.followerId}">
				                            				<div id="followBtn" style="text-align:center;">
				                            					<a id="deleteFollow"  onclick="return confirm ('팔로우 취소 하시겠습니까?');" href="deleteFollow.do?followingId=${productDetailView.fundMakerId }&followerId=${user.memberId }&fundIdx=${productDetailView.fundIdx }">
								                            		<i class="fa-solid fa-check"></i>&nbsp; 팔로우 취소
								                            	</a>	
							                            	</div>
				                            			</c:if>
				                            			<c:if test="${user.memberId eq null || user.memberId eq '' }">
				                            				<form action="loginForm.do">
				                            					<div id="followBtn" style="text-align:center;">
				                            						<button type="button" onclick="loginForm_Go()" name="following" class="followButton" id="following"><i class="fa fa-user-plus"></i>&nbsp; 팔로우</button>
				                            					</div>
				                            				</form>
				                            			</c:if>
						                            </div>
							                    ...
							                    <div class="single_product_desc" style="text-align: left;">
							                        ...
							                        <c:if test="${not empty fundOptionView }">
							                          <div class="maker-information">
									                        ...
									                        <div >
							                            		<p><i class="fa fa-money"></i>&nbsp; ${fundOptionView.fundOptionPrice} 원 펀딩</p><br>
							                            	</div>
							                            	<div>
							                            		<p><i class="fa fa-bus"></i>&nbsp; 배송비 : ${fundOptionView.fundOptionDelivery } 원</p><br>
							                            	</div>
