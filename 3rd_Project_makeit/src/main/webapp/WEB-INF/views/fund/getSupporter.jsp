                ...
                <div class="col-12">
                    <div class="product_details_tab section">
                        ...
                        <ul class="nav nav-tabs" role="tablist" id="product-details-tab">
							<li class="nav-item">
									<a href="productDetailView.do?fundIdx=${productDetailView.fundIdx }" class="nav-link" >스토리</a>
							</li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="getSupporter.do?fundIdx=${productDetailView.fundIdx }" class="nav-link active" >서포터 (${productDetailView.supporterCnt })</a>
                            </li>
                        </ul>
	              			  ...
	              			  <c:if test="${not empty getSupporter }">
	              			  	<div class="supporter_area">
	              			  		<c:forEach var="getSupporter" items="${getSupporter }">
	              			  			<p>${getSupporter.memberId } 님이 ${getSupporter.fundPrice }원 펀딩으로 참여하였습니다. </p>
	              			  			<hr>
	              			  		</c:forEach>
	              			  	</div>
	              			  </c:if>
