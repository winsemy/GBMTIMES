	                        ...
	                        <form action="QnaInsert.do">
	                            <div class="contact_input_area">
	                                <div>
	                               		...
	                               		<i class="fa fa-gift"></i><label>&nbsp; <input type="radio" name="qnaCategory" value="상품">&nbsp; 상품</label>&nbsp; &nbsp; &nbsp; &nbsp; 
	                               		<i class="fa fa-bus"></i><label>&nbsp; <input type="radio" name="qnaCategory" value="배송">배송</label>&nbsp; &nbsp; &nbsp; &nbsp; 
	                               		<i class="fa fa-close"></i><label>&nbsp; <input type="radio" name="qnaCategory" value="반품/취소">반품/ 취소</label>&nbsp; &nbsp; &nbsp; &nbsp; 
	                               		<i class="fa fa-exchange"></i><label>&nbsp; <input type="radio" name="qnaCategory" value=교환/변경>교환/변경</label>&nbsp; &nbsp; &nbsp; &nbsp; 
	                               		<i class="fa fa-reorder"></i><label>&nbsp; <input type="radio" name="qnaCategory" value="기타">기타</label><br>
	                               	</div>
	                                <div class="row">
	                                 	<div class="col-12">
	                                        <div class="form-group">
	                                       		<br><div>작성자 : ${vo.memberId }</div><br>
	                                        </div>
	                                    </div>
	                                    <table>
	                                    	<tr>
	                                    		<th></th>
	                                    		<td>
	                                    			<input type="text" class="form-control" id="qnaTitle" name="qnaTitle" placeholder="제목"><br>
	                                    		</td>
	                                    	</tr>
	                                    	...
	                                    	<tr>
	                                    		<th></th>
	                                    		<td>
	                                    			<textarea class="form-control" id="qnaContent" name="qnaContent" rows="30" cols="150" placeholder="문의글 작성"></textarea><br>
	                                    		</td>
	                                    	</tr>
	                                    </table>
	                                    <div class="container">
