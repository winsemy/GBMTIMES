				...
				<div class="StorePaymentSection_sectionContent__1a3aW StorePaymentSection_active__2fVyM">
					<div class="StorePaymentInformation_storePaymentInformation__nBaVr">
						<div>
							...
							<p class="StorePaymentProductInfo_productDescription__3-3a_">수량
								: 개</p>
                    ...
                    <div class="single_product_desc">
						...
						<div style="font-weight: 200;">
							...
							<div style="float: right; font-size: 13px;">
								...
								<span>아직.. </span><br>
								<span>${detail.storeDel } 원</span><br>
							</div>
						</div>
						<br><br><hr>
						...
						<span style="float: right; font-size: 13px;" id="orderPrice">${option.storeOptionprice + detail.storeDel }</span><br><br><br>
							<input type="checkbox" style="width: 18px; height: 18px;" class="Allchk"> 결제 진행 필수 동의<br>
                        ...
                        <!--  폼데이터 바꿔야됨!~! -->
                            ...
                            <button name="ordersPrice" type="submit" class="btn btn-primary btn-block"  style="background-color: #00B2B2;" value="${option.storeOptionprice + detail.storeDel }">${option.storeOptionprice + detail.storeDel }원 결제하기</button>
                    </div>
                </div>
            </div>
        </div>
