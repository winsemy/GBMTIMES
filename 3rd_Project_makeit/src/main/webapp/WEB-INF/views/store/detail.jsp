                ...
                <div class="col-12 col-lg-5">
                    <div class="bbox">
                        ...
                        <div class="single_product_ratings mb-2">
                            ...
                            <span class="text-muted">${cnt.sum }(${cnt.cnt } Reviews)</span>
                        </div>
                        <h4 class="price mb-4">${detail.storePrice }원</h4>
						<hr>
						<!-- 배송안내 -->
						<div>
                        ...
                        <form method="post" action="order.do">
                               <select name="storeOption" id="order" style="" class="selectbox">
                               <option value="" >상품을 선택해주세요</option>
		                            <c:forEach var="option" items="${option }">
		                               		<option value="${option.storeOption }">
		                               			<h4>${option.storeOption }</h4>
		                               		</option>
		                            </c:forEach>
                               </select>
                        <!-- 주문하기 -->
                            ...
                            <div id="star">
                            	<div class="score">
                            		<div class="review-rating" style="margin-bottom: 5px;">
                            			<i class="fa fa-star" aria-hidden="true" style="font-size: 2em;"></i><span style="font-size: 1.5em;">${cnt.sum }</span><span style="font-size: 0.5em; color: silver;" >/5.0</span><span  style="color: black; font-weight:lighter;;">(${cnt.cnt })</span>
                            		</div>
                            	</div>
                            </div>
                            	<hr>  
                                        ...
                                        <li>
                                            <div class="single_user_review mb-15">
                                                ...
                                                <div class="review-details">
                                                	<img alt="" src="img/store-img/${re.storeReviewImg }" style="">
