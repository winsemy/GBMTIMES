			...
			<div class="col-12">
				<div class="product_details_tab section_padding_100_0 clearfix">
					...
					<ul class="nav nav-tabs" role="tablist" id="product-details-tab">
						...
						<li class="nav-item">
							<a href="#" onclick="javascript:location.href='notice_EVENT.do?category=EVENT'" class="nav-link active" data-toggle="tab" role="tab" style="color: #00c4c4;">Event<span class="text-muted">(${eventCnt})</span></a>
						</li>
					</ul>
					<!-- Tab
					<!-- Tab Content -->
								...
								<c:otherwise>
									<c:forEach var="nlist" items="${list}">
										<div class="board-main">
											<ul>
												<li>
													<a class="article no-thumb" href="notice_detail.do?csIdx=${nlist.csIdx }&category=EVENT">
														<c:choose>	
									...
									<div class="shop_pagination_area mt-30">
										<nav aria-label="Page navigation">
											<ul class="pagination pagination-sm justify-content-center"  style="display: flex;" id="ajaxpageinsert" >
												...
												<c:if test="${page.beginPage!=1 }">
													<li class="page-item">
														<a class="page-link" href="notice_EVENT.do?cPage=${page.beginPage-1}&category=EVENT"><i class="fa fa-angle-left" aria-hidden="true"></i></a>
													</li>
												</c:if>
												...
												<c:forEach var="pageNo" begin="${page.beginPage }" end="${page.endPage }">
													...
													<c:if test="${pageNo != page.nowPage }">
														<li class="page-item">
															<a class="page-link" href="notice_EVENT.do?cPage=${pageNo }&category=EVENT">${pageNo }</a>
	 													</li>
													</c:if>
												</c:forEach>
												...
												<li class="page-item"> 
													<a class="page-link" href="notice_EVENT.do?cPage=${page.endPage +1 }&category=EVENT"><i class="fa fa-angle-right" aria-hidden="true"></i></a>
												</li>
												</c:if>
												<c:if test="${page.endPage >= page.totalPage  }">
													<li class="page-item">
