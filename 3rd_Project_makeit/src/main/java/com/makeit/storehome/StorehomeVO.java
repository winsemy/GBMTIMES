...
public class StorehomeVO {
	...
	storeSatisfy, memberId, storeDel2, storeOption, storeOptiondetail, ordersOptionTitle;
	...
	private String storeReviewImg, 	storeReviewScore, storeReviewContent, storeReviewRegdate;
	
	private String qnaIdx, qnaTitle, qnaContent, qnaImg, qnaDate, qnaHit, qnaDelete,
	qnaCategory,qnaChange, qnaReContent, qnaReDate;
	...
	public String toString() {
		return "StorehomeVO [storeIdx=" + storeIdx + ", storeTitle=" + storeTitle + ", storePrice=" + storePrice
				...
				+ ", storeReviewRegdate=" + storeReviewRegdate + ", qnaIdx=" + qnaIdx + ", qnaTitle=" + qnaTitle
				+ ", qnaContent=" + qnaContent + ", qnaImg=" + qnaImg + ", qnaDate=" + qnaDate + ", qnaHit=" + qnaHit
				+ ", qnaDelete=" + qnaDelete + ", qnaCategory=" + qnaCategory + ", qnaChange=" + qnaChange
				+ ", qnaReContent=" + qnaReContent + ", qnaReDate=" + qnaReDate + ", cnt=" + cnt + ", sum=" + sum
				+ ", nowPage=" + nowPage + ", nowBlock=" + nowBlock + ", numPerPage=" + numPerPage + ", numPerBlock="
				...
				+ ", uploadFile=" + uploadFile + ", storeDel=" + storeDel + ", storeOptionprice=" + storeOptionprice
				+ "]";
	}
