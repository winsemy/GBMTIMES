...
public class Paging {
	...
	private int numPerPage = 5; //한페이지에 게시글목록의 갯수지정하는 변수
	private int numPerBlock = 5; //한페이지에 block에 보여지는 숫자의 갯수를 지정하는 변수
...
//=======================================================================================//
	//더보기 및 스크롤 페이징 처리를 위한 변수
	private int startNum=1;
	private int endNum= 9;
	private int addNum = 9;
	private int fundListCnt =0;


	public int getFundListCnt() {
		return fundListCnt;
	}
	public void setFundListCnt(int fundListCnt) {
		this.fundListCnt = fundListCnt;
	}
