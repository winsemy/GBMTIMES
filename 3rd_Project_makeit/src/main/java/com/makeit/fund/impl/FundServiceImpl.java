...
//==================================================================
	...
	public List<FundVO> myQnaList(int begin, int end, String memberId, String fundIdx) {
		List<FundVO> list = fundDAO.myQnaList(begin, end, memberId, fundIdx);
		return list;
	}
	...
	public void insertFollow(FundVO vo) {
		fundDAO.insertFollow(vo);
	}
	@Override
	public void deleteFollow(FundVO vo) {
		fundDAO.deleteFollow(vo);
	}
	@Override
