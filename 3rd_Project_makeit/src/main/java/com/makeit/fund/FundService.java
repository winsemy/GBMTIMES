...
// ========================================================
	...
	void rewardInsert(FundVO vo); // rewardInsert
	void couponCheck(FundVO vo); // 쿠폰 상태 변경
	void fundPriceUpdate(FundVO vo); // FUND_PRICE 가격 업데이트
	void insertFollow(FundVO vo);
	void deleteFollow(FundVO vo);
...
// ========================================================
	...
	List<FundVO> myQnaList(int begin, int end, String memberId, String fundIdx); //페이징 처리를 위한 my QnA List
// ========================================================
	// 좋아요
	int fundLikeCnt(FundVO vo);
	void fundLikeUpdate(FundVO vo);
	void fundLikeDelete(FundVO vo);
	void insertLike(FundVO vo);
	void deleteLike(FundVO vo);
