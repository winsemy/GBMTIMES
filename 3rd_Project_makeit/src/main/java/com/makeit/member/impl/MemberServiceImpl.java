...
public class MemberServiceImpl implements MemberService {
	...
	@Override
	public int couponTotalCnt() {
		return MemberDAO.couponTotalCnt();
	}
	@Override
	...
	@Override
	public List<AdminVO> couponTotalList(int begin, int end) {
		return MemberDAO.couponTotalList(begin,end);
	}
	@Override
